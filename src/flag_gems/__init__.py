...
_FULL_CONFIG = (
    ...
    ("constant_pad_nd", constant_pad_nd, None, (AUTOGRAD_DISPATCH_KEY,)),
    ...
    ("div_.Scalar", true_divide_, None, (AUTOGRAD_DISPATCH_KEY,)),
    ("div_.Scalar_mode", div_mode_),
    ("div_.Tensor", true_divide_tensor_, None, (AUTOGRAD_DISPATCH_KEY,)),
    ...
    ("divide_.Scalar", true_divide_, None, (AUTOGRAD_DISPATCH_KEY,)),
    ("divide_.Scalar_mode", div_mode_),
    ("divide_.Tensor", true_divide_, None, (AUTOGRAD_DISPATCH_KEY,)),
    ...
    ("ormqr", ormqr),
    ("outer", outer),
    ("pad", pad, None, (AUTOGRAD_DISPATCH_KEY,)),
    ...
    ("true_divide_.Scalar", true_divide_, None, (AUTOGRAD_DISPATCH_KEY,)),
    ("true_divide_.Tensor", true_divide_tensor_, None, (AUTOGRAD_DISPATCH_KEY,)),
    ("trunc", trunc),
    ("trunc_", trunc_),
    ("unbind.int", unbind),
